...
public class PushExample {
    ...
    protected static final String APP_KEY = "bdbb767723951b7aca438736";
    protected static final String MASTER_SECRET = "2c0e4c4efb74f0f9b574cb8b";
...
//                List<PushPayload> pushPayloadList = new ArrayList<>();
//                PushPayload.Builder builder1 = PushPayload.newBuilder();
//                builder1.setMessage(Message.content("cbuildPushObject_all_all_alertontent1 by regId"))
//                        .setNotification(Notification.alert(ALERT))
//                        .setPlatform(Platform.android())
//                        .setAudience(Audience.all())
//                        .setOptions(Options.sendno())
